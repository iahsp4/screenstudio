 ...
 */
package org.screenstudio.remote;
...
public class WebRemote implements Runnable {
    ...
    private void Listen() {
        ...
        try {
            ...
            while (!stopServer) {
                ...
                try {
                    // wait for request
                    System.out.println("ScreenStudio Remote accepting connections on port " + port);
                    ...
                    if (!request.startsWith("GET") || request.length() < 14
                        ...
                        if (req.contains("..")
                            ...
                            String path = "/org/screenstudio/remote/resources" + req + ".html";
                            try {
                                // send file
    ...
    private void errorReport(PrintStream pout, Socket connection,
        ...
        pout.print("HTTP/1.0 " + code + " " + title + "\r\n"
                ...
                + "</HEAD><BODY>\r\n"
                + "<H1>" + title + "</H1>\r\n" + msg + "<P>\r\n"
                + "<HR><ADDRESS>ScreenStudio 1.0 at "
